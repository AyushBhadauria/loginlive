...
/***/ "../../../../../src/app/components/sign-up/validators/form.validators.ts":
...
var FormValidator = /** @class */ (function () {
    ...
    FormValidator.validContact = function (control) {
        if (isNaN(control.value))
            return { validContact: true };
        return null;
    };
    FormValidator.validEmail = function (signupService) {
        return function (control) {
            return signupService.checkEmailNotTaken(control.value).map(function (res) {
                return res ? null : { emailTaken: true };
            });
        };
    };
    FormValidator.passwordValidator = function (control) {
